...
const Card = () => {
  return (
    <div className="h-screen w-screen flex items-center justify-center">
      ...
      bg-conic/[from_var(--border-angle)] from-neutral-200 via-green-500 to-orange-500
      from-90% via-95% to-100% animate-border-rotate p-px">
        <div className="py-52 rounded-lg text-center dark:text-white bg-white dark:bg-neutral-950">
