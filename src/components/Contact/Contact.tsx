...
const formSchema = z.object({
  ...
  tel: z
    ...
    .regex(/^\+?(\d{1,4})?[-.\s]?\d{10}$/, {
      message:
        "Enter a valid phone number (e.g., +91 9876543210 or 9876543210).",
    }),
...
const Contact = () => {
  ...
  const onSubmit = (data: z.infer<typeof formSchema>) => {
    setIsSubmit(true);
    emailjs
      .send("service_0d29e67", "template_3t8y9b3", data, {
    ...
    <div className=" bg-background">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="my-4 border-gray-700">
          <p className="text-center text-2xl sm:text-xl py-2">
            We'd{" "}
            <FaHeart className="inline text-primary hover:text-red-600  active:text-red-600 transition-all duration-300 ease-in-out" />{" "}
            to help!
          </p>
          <hr />
        </div>
          ...
          <div className="w-full md:w-1/2 justify-center items-center p-6 space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-lg tracking-normal">
                ...
                including V-Groove Engraving, CEP, Beveling, Decorative
                Laminated Glass, Mirrors, Smart Glass, Toughened Glass, and Bend
                Glass, designed to enhance any space with style and durability.
              </p>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <p>
                Unit NO: 1, Ghaswala Estate, Swami Vivekananda Rd, opp. 24
                Karat, Jogeshwari West, Mumbai-400102
              </p>
            </div>
