...
const Card = () => {
  return (
    <div className="flex items-center justify-center my-5 p-4 lg:p-2">
      ...
      from-90% via-95% to-100% animate-border-rotate p-px">
        <div className="py-20 md:py-40 rounded-lg text-center dark:text-white bg-white dark:bg-neutral-950">
